...
User.create!(name: "Shane Morgan", email: "shane@cd2solutions.co.uk", password: 'password', admin: true, sub_admin: true)
...
User.create!(name: "Amanda Abbs", email: "amanda@business-first.com", password: 'password', sub_admin: true)
...
User.create!(name: "Sally Morgan", email: "sally@business-first.co.uk", password: 'password', admin: true, sub_admin: true)
